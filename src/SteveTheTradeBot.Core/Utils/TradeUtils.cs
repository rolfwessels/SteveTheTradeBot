    ...
    public static class TradeUtils
    {
        ...
        public static void Print(this StrategyInstance backTestResult)
        {
            ...
            Console.Write(backTestResult.Trades
                .Select(x => new {x.StartDate,DaysIn = (x.EndDate - x.StartDate).GetValueOrDefault().ToShort(), x.BuyValue, Quantity = x.BuyQuantity, x.BuyPrice, x.SellPrice , x.Profit , x.FeeAmount}).ToTable()
                .ToString());
